...
# ╔═╡ 1859b20b-1f2b-408e-8b91-a124a3997082
begin
	using Plots, PlutoUI
		plotly();
html"""
...
# ╔═╡ 631ad708-5542-4180-93af-6aa91cf2b777
md""" ### Play with the amplitude of the external current $I$

I = $(@bind I Slider(-1:0.1:5, default=0, show_value=true))"""

# ╔═╡ a9edb121-d2a0-4bfc-b5a7-991b2b174078
begin 
...
# ╔═╡ f23281a5-2558-4130-bcb3-1f940e5c45d2
begin
W, freq = IF(I)
...
# Plotting instructions ------------------------------------------------------		
	...
	plot!(time, θ * ones(N,1), 
		label="Threshold", 
		color = :red,
		linewidth = 1,
		leg = :false);   # Analytical sol. of a RC compartment 


	plot!(time, Wanalyt, 
		label="Analytical solution (of a RC) - w/o threshold", 
		color = :blue,
		linewidth = 1,
		leg = :false);   # Analytical sol. of a RC compartment 
...
md""" ### Explore absolute refractoryness
I0 = $(@bind I0 Slider(0:1:100, default=0, show_value=true))
"""

# ╔═╡ 9a5e096e-9058-4965-9acc-4c4e767e4a4a
md"""
I1 = $(@bind I1 Slider(0:0.1:100, default=0, show_value=true))
"""

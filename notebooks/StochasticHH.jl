...
We augment the the Hodgkin and Huxley model with an **effective** description of ion-channel flickering. This makes possible for the model to display non-deterministic responses and a series of other phenomena thought to arise from the so-called *channel-noise*.
...
md"""
The larger $I$, the higher the frequency of generated action potentials. 
"""
